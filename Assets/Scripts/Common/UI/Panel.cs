...
[RequireComponent(typeof(LayoutAnchor))] // checks for missing dependencies during the moment the component is added to a GameObject
//tell us if we are not working with LayoutAnchor
