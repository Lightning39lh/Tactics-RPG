...
{
    //for the Panel and Pool Manager
    #region Constants
	...
	[SerializeField] GameObject entryPrefab; //for instantiating our pooled objects
    [SerializeField] Text titleLabel;
	[SerializeField] Panel panel; //for Toggling visibility and for a container for menu entries
    [SerializeField] GameObject canvas; //for dosable/enable
