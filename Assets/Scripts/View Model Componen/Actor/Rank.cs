...
public class Rank : MonoBehaviour
{
    ...
    {
        get { return (float)(LVL - minLevel) / (float)(maxLevel - minLevel); } //for UI
    }
    Stats stats;
    #endregion
    ...
    {
        float levelPercent = Mathf.Clamp01((float)(level - minLevel) / (float)(maxLevel - minLevel)); //return a number in [0,1]
